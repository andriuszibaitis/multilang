    ...
    plugins: [
        ...
        },
        {
            ...
            options: {
                ...
                theme_color: '#0E283F',
                theme_color_in_head: false, // Avoids adding theme-color meta tag. Configured in React Helmet instead.
                display: `fullscreen`,
        ...
        },
        {
            ...
            options: {
                fonts: [
                    `Montserrat:400,600,700,800`, // you can also specify font weights and styles
                ],
                display: 'swap',
            },
        },
